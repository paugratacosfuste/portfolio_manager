...
def render_suggestions():
    ...
    if st.button("Generate Personalized Advice (Claude)"):
        with st.spinner("Claude is analyzing your portfolio..."):
            ...
            st.markdown("<div style='background-color:#EBF5FF; padding:1.5rem; border-radius:10px; border-left: 5px solid #3A6EA5;'>", unsafe_allow_html=True)
            st.markdown(f"**Claude's Analysis:**\n\n{advice}")
